...
import datos_asistentes from "../../DatosDAFO/datos_asistentes.json";
import datos_analistas from "../../DatosDAFO/datos_analistas.json";
import datos_coordinadores from "../../DatosDAFO/datos_coordinadores.json";
import datos_representantes from "../../DatosDAFO/datos_representantes.json";
import datos_gerentes from "../../DatosDAFO/datos_gerencia.json";
import datos_administradores from "../../DatosDAFO/datos_administradores.json";
import datos_tecnicos from "../../DatosDAFO/datos_tecnicos.json";
...
export default {
  ...
  mounted() {
    this.logo_image = require("../../assets/Logo_DAFO.png");

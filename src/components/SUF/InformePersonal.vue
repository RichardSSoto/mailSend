          ...
          <q-list>
            ...
            <q-item>
              ...
              >
                Grupo Ocupacional :
                <span style="font-size: 18px;font-weight: 400;color: black;:">
                  {{trabajador.grupo_ocupasional | obtenerGrupoOcupacional(labels_ocupacion)}}
                </span>
              </q-item-section>
            </q-item>
            <q-separator spaced inset />
            ...
            <div v-for="(label, index) in competencias_labels" :key="index">
              <q-item v-if="trabajador[label.value]">
                ...
                >
                  ...
                  <span
                    style="font-size: 18px;font-weight: 400;color: black;"
                    >{{trabajador[label.value] | category_filter(filter_categorias_value)}}
                    </span
                  >
                </q-item-section>
              </q-item>
...
export default {
  ...
  mounted() {
    this.logo_image = require("../../assets/Logo_SUF.png");
    ...
    downloadVisualReport() {
      ...
      html2canvas(this.$refs.capture)
        .then(canvas => {
          ...
          doc.addImage(this.logo_image, "PNG", 10, 0, 37.5, 23);
